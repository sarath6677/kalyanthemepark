                    ...
                    <div class="card-body">
                            <div class="row">
                                <div class="col-md-10 p-3">
                                    {{ __('The ThemePark API is a low-level HTTP-based API for a Laravel admin starter kit that you can use to')}}  <code>create/edit/update</code><br> {{ __('ThemePark API uses')}}<code>Laravel Passport</code>
