                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <div class="mar-ver pad-btm text-center mb-3">
                            <h1 class="h3">{{ translate('6cash Software Update') }}</h1>
                            <span class="alert-warning text-danger px-1" role="alert">
                                    {{ translate('Note: Update can take more than 5 minutes. Please do not close the window.') }}
                            </span>
                            @if(env('SOFTWARE_VERSION') == 4.3)
                                <div class="alert alert-danger px-1 mt-2" role="alert">
                                    ...
                                    <a class="alert-link" target="_blank" href="https://docs.6amtech.com/docs-six-cash/admin-panel/mandatory-setup#firebase-configuration-for-notification">{{ translate('kindly follow the documentation') }}</a>
                                </div>
                            @endif
                        </div>
